...
class PMWindow(QMainWindow):
    ...
    def deletepmclicked(self):
        if len(self.pmlist.selectionModel().selection().indexes()) > 0:
            ...
            associated_freqs = selected_struct.freq_associated_id(
            ...
            self.datas.pm.remove(self.selectedpm)
    ...
    def addPm(self):
        ...
        selected_struct = self.pump.struct
        associateded_freqs = selected_struct.freq_associated_id(freq.id)
    ...
    def modifyPm(self):
        ...
        selected_struct = self.pump.struct
        associated_freqs = selected_struct.freq_associated_id(self.selectedpm.freq.id)
